...
import { Command, CommandList,CommandInput,CommandEmpty, CommandItem, CommandSeparator } from "@/components/ui/command";
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                ...
                className={cn("w-[200px] justify-between",className)}>
                    <StoreIcon className="mr-2 h-4 2-4"></StoreIcon>
                    {currentStore?.label}
